...
export default function Hadith() {
  ...
  // Daftar perawi yang termasuk dalam Kutubus Sittah
  const mainBooks = ["bukhari", "muslim", "abu-daud", "tirmidzi", "nasai", "ibnu-majah"];
    ...
    <div className="min-h-screen bg-slate-50 pb-10">
      ...
      <div className="bg-emerald-600 text-white sticky top-0 z-30 shadow-lg px-3 py-3 sm:px-6 sm:py-4">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Baris Bawah: Filter Kategori */}
          <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
            {["Semua", "Kutubus Sittah"].map((cat) => (
              <button
                key={cat}
